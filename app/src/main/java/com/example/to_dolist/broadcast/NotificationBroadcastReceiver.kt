package com.example.to_dolist.broadcast
...
import com.example.to_dolist.utils.Constance.NOTIFICATION_ID_TODO_REMINDER
...
class NotificationBroadcastReceiver : BroadcastReceiver() {
    ...
    private fun pushNotification(context: Context, task: Task) {
        ...
        with(NotificationManagerCompat.from(context)) {
            ...
            notify(NOTIFICATION_ID_TODO_REMINDER, notification.build())
        }
    }
}